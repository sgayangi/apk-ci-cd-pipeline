...
6.1 Retrieve the dev environment's EXTERNAL-IP address.
    ...
    Hello, abce from dev environment!
    ```
## Deploy the API to the stage environment and test
1. Go to the Actions under your forked repository.
...
7. Test the API by sending a request to the stage environment.
</br>
6.1 Retrieve the dev environment's EXTERNAL-IP address.
</br>
    ```
    ...
    ```
    6.2 Create etc host entry for the stage environment's EXTERNAL-IP 
    address.
</br>
    ```
